    ...
    <div class="book-details-container">
        ...
        <div class="book-details">
            ...
            <div class="book-actions">
                ...
                <?php
                    $inWishlist = in_array($book['book_id'], $wishlistBookIds);
                    $outOfStock = $book['stock_quantity'] <= 0;
                ?>

                <a href="javascript:void(0)" onclick="<?= isset($_SESSION['user']) ? "openQty('../logic/cart/addToCart.php?book_id={$book['book_id']}')" : "window.location.href='login.php'" ?>" class="add">
                ...
                onclick="<?= (!$outOfStock && isset($_SESSION['user'])) 
                        ? "openQty('../logic/purchases/purchaseNow.php?book_id={$book['book_id']}')" 
                        : "return false;" ?>">
